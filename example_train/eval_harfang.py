...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="gym_harfang_random", help="id of environment")
    ...
    parser.add_argument("--max_iteration", type=int, default=800*6000)  
    ...
    parser.add_argument("--sample_batch_size", type=int, default=1)    # 与环境交互sample的次数，交互完成后存入replay buffer
    ...
    parser.add_argument("--num_eval_episode", type=int, default=6)
    parser.add_argument("--eval_interval", type=int, default=25*6000)
    parser.add_argument("--eval_save", type=str, default=False, help="save evaluation data")

    ################################################
    # 7. Data savings
    #parser.add_argument("--save_folder", type=str, default= "B:/code/DSAC/results/DSAC/harfang")
    parser.add_argument("--env_port", type=int, default=13579)
...
# python example_train/eval_harfang.py --ini_network_dir results/DSAC/harfang/2/apprfunc/apprfunc_2700000_opt.pkl --env_id gym_harfang_random --seed 1
# python example_train/eval_harfang.py --ini_network_dir results/DSAC/harfang/2/apprfunc/apprfunc_2700000_opt.pkl --env_id gym_harfang --seed 1
# python example_train/eval_harfang.py --ini_network_dir results/DSAC/harfang/2/apprfunc/apprfunc_2700000_opt.pkl --env_id gym_harfang_infinite --seed 1

# -10952.1, -10727.4, -10326.9, -10548.3, -10425.3
# 0, 4, 2, 0, 0
# -1747.8, -1747.8, -1747.8, -1747.8, -1747.8
# 98, 98, 98, 98, 98
# 9776 5