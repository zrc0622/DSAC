...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="gym_harfangserpentine", help="id of environment") # gym_harfangstraightline or gym_harfangserpentine
    ...
    parser.add_argument("--save_folder", type=str, default= "B:/code/DSAC/results/DSAC/harfang_serpentine_line")
